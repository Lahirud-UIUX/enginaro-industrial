...
const AboutPage = () => {
  return (
    <main className="bg-gray-50 dark:bg-dark-background min-h-screen">
      <div className="pt-32 pb-16">
        ...
        <section className="w-full max-w-[1300px] mx-auto py-16 px-4 md:px-6 bg-white dark:bg-dark-card rounded-3xl mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
              ...
              <div className="flex flex-col gap-6">
                ...
                <motion.h2 
                  ...
                  viewport={{ once: true }}
                  className="text-3xl md:text-4xl font-bold text-black dark:text-black font-primary"
                >
              ...
              <div className="relative">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="p-8 bg-gray-50 dark:bg-dark-background rounded-3xl relative z-10"
                >
                    ...
                    <div className="flex flex-wrap gap-3">
                      {['SolidWorks', 'AutoCAD', 'Fusion 360', 'ANSYS', 'Abaqus', 'IoT'].map((tool, index) => (
                        <motion.div
                          ...
                          className="px-4 py-2 bg-white dark:bg-dark-card rounded-full text-black dark:text-black text-sm font-medium"
                        >
                          {tool}
                        </motion.div>
                      ))}
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#3D3D3D] dark:text-white/80">Established in 2024 through strategic merger</p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#3D3D3D] dark:text-white/80">Growth of capabilities and client portfolio</p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#3D3D3D] dark:text-white/80">Continuing to pioneer advanced solutions</p>
                        </div>
                      </motion.div>
                    </div>
                  </div>
...
const ValueCard = ({ icon: Icon, title, description, index }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-dark-card rounded-3xl p-8 flex flex-col"
    ...
    >
      ...
      <p className="text-[#3D3D3D] dark:text-white/80 font-secondary">{description}</p>
    </motion.div>
  );
};
...
const TeamMember = ({ index }) => {
  ...
  return (
    <motion.div
      ...
      animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
      transition={{ duration: 0.5, delay: 0.1 * index }}
      className="bg-white dark:bg-dark-card rounded-3xl overflow-hidden"
      whileHover={{ y: -10, transition: { duration: 0.3 } }}
    >
