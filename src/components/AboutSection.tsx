      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-4">
          ...
          >
            <div className="h-full max-w-[578px] mx-auto flex flex-col gap-6">
              <motion.h2 
                ...
                className="text-4xl font-bold text-black dark:text-black mt-8 font-primary"
              >
                WHO WE ARE?
              </motion.h2>
              ...
              <motion.p 
                ...
                className="text-[#3D3D3D] dark:text-[#3D3D3D] text-lg font-secondary"
              >
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex flex-col gap-4">
                  <motion.h3 
                    ...
                    className="text-2xl font-bold text-black dark:text-black font-primary"
                  >
                  ...
                  <motion.p 
                    ...
                    className="text-[#3D3D3D] dark:text-[#3D3D3D] font-secondary"
                  >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-10 right-10 w-20 h-20 rounded-full bg-primary/20"
          ...
          <motion.div
            ...
            className="absolute bottom-20 left-10 w-16 h-16 rounded-full bg-white/20"
            style={{ backdropFilter: 'blur(8px)' }}
          >
            <motion.div
              animate={{ 
