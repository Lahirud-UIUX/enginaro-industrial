  ...
  return (
    <footer className="w-full mx-auto mb-8 mt-16 px-[20px]">
      <SectionAnimation
        ...
        id="cta"
      >
        <div className="bg-black dark:bg-dark-surface rounded-3xl overflow-hidden relative h-[500px]">
          {/* Background Image */}
          ...
          {/* Content Container */}
          <div className="relative w-full h-full mx-auto flex items-center justify-center px-4 md:px-6 lg:px-16">
            <motion.div 
