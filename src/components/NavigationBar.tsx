  ...
  return (
    <>
      <motion.nav 
        ...
        className={`max-w-[1300px] w-full h-20 rounded-[100px] ${scrolled ? 'bg-black shadow-lg' : 'bg-black/90'} flex items-center justify-between px-4 fixed top-8 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300`}
      >
        {/* Logo */}
        <motion.div 
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div 
            ...
            className="fixed inset-0 bg-black bg-opacity-95 z-40 md:hidden flex flex-col justify-center items-center"
          >
            <motion.div 
              variants={staggerContainer}
              initial="hidden"
            ...
            >
              ...
              <motion.div variants={fadeInUp}>
                <Link href="/blog" className="text-2xl font-semibold text-white hover:text-primary transition-colors duration-300" onClick={toggleMenu}>
                  Projects
                </Link>
              </motion.div>
